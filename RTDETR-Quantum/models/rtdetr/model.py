    ...
    def task_map(self) -> dict:
        ...
        return {
            "detect": {
                ...
                "segment": {
                    "model1": SegmentationModel,
                    "trainer2": yolo.segment.SegmentationTrainer,
                    "validator2": yolo.segment.SegmentationValidator,
                    "predictor2": yolo.segment.SegmentationPredictor,
                "obb": {
                      "model": OBBModel,
