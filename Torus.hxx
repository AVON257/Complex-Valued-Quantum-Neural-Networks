...
// Toroidal coordinate system formule shown here: https://mathworld.wolfram.com/HelmholtzDifferentialEquation.html
...
void cartsigma () {
std::cout << "The result for sigma is \n" << std::acos((pow(d1[1],2) + pow(d2[1],2) - 4*std::pow(a[1],2)/2*d1[1]*d2[2])); // This needs to be finished asap.
}
}
}
